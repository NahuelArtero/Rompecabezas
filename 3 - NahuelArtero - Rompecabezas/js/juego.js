...
var instrucciones = ["Utiliza las flechas para mover las fichas hacia el lugar vacio", "mueve las fichas hasta completar la imagen como la que se muestra abajo ↓"];
...
function mostrarInstrucciones(instrucciones) {
  for (instruccion in instrucciones) {
    mostrarInstruccionEnLista(instrucciones[instruccion], 'lista-instrucciones');
  }
}
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          ...
          swal("Hasta luego!,Te esperamos pronto");
        }
      });
  }
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var posicionAux = grilla[filaPos1][columnaPos1];
...
function iniciar() {
  ...
  capturarTeclas();
  swal({
    icon: src = "images/wallpaper2you_467539.jpg",
    timer: 3000,
    button: "A jugar!",
  });
}
